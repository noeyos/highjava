...
public class ArrayListTest01 {
	...
	public static void main(String[] args) {
		...
		// contains(비교데이터) ==> 리스트에 저장된 데이터 중에서 '비교데이터'가 있으면 true, 없으면 false
		...
		// ==> 리스트에서 '비교데이터'가 있으면 '비교데이터'가 저장된 index값을 반환하고, 없으면 -1을 반환한다.
		// ==> indexOf() 메서드는 검색 방향이 앞에서 뒤로 검색하고,
		//	   lastIndexOf() 메서드는 검색 방향이 뒤에서 앞으로 검색한다.
		// ==> 리스트의 '비교데이터'가 많으면 검색해서 첫번째로 찾아진 데이터의 위치값을 반환한다.
