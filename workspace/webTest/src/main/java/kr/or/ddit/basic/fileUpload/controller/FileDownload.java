...
public class FileDownload extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FileInfoVO fvo = service.getFilInfo(fileNo);
		
		
		// 파일이 저장된 폴더 설정
		String uploadPath = "e:/e_other/web/uploadFiles";
		...
		// 다운 받을 파일명(저장된 파일명)을 이용할 File객체 생성
...
//			String headerValue = "attachment; filename=\"" + fvo.getOrigin_file_name() + "\";";
	...
	// 다운로드할 파일명에 한글이 포함된 경우 한글이 깨지는 것을 방지하는 메서드
